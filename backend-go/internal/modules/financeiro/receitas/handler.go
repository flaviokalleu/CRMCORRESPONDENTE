// Package receitas implementa o CRUD de `routes/receitas.js` — mount
// `/api/receitas` (authenticateToken + resolveTenant, ver 03-spec §4).
package receitas
...
func (h *Handler) create(c *gin.Context) {
	...
	m := &models.Receita{
		...
		Data: req.Data, ContratoID: req.ContratoID,
...
func (h *Handler) update(c *gin.Context) {
	...
	updates := map[string]any{
		"tipo": req.Tipo, "valor": req.Valor, "descricao": req.Descricao,
		"data": req.Data, "contratoId": req.ContratoID, "updatedAt": time.Now(),
	}
