  ...
  return (
    <div className="p-6 max-w-2xl">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-xl font-semibold text-white">Cadastrar imóvel para aluguel</h1>
        <Link href="/alugueis" className="text-sm text-white/50 hover:text-white">
          Voltar
        </Link>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm text-white/70 mb-1">Nome / Endereço *</label>
          <input
            type="text"
            name="nome_imovel"
            ...
            className="w-full rounded-md border border-white/10 bg-white/5 px-3 py-2 text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-orange-500/40"
          />
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div>
            <label className="block text-sm text-white/70 mb-1">Valor do aluguel *</label>
            <input
              type="number"
              step="0.01"
              min="0"
          ...
          <div>
            <label className="block text-sm text-white/70 mb-1">Quartos</label>
            <input
              type="number"
              min="0"
              max="10"
          ...
          <div>
            <label className="block text-sm text-white/70 mb-1">Banheiros</label>
            <input
              type="number"
              min="0"
              max="10"
          ...
          <div>
            <label className="block text-sm text-white/70 mb-1">Dia vencimento</label>
            <input
              type="number"
              min="1"
              max="31"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-sm text-white/70 mb-1">Foto de capa</label>
            <input
              type="file"
              accept="image/*"
          ...
          <div>
            <label className="block text-sm text-white/70 mb-1">Fotos adicionais</label>
            <input
              type="file"
              accept="image/*"
              multiple
        ...
        {success && (
          <div className="rounded-md border border-green-500/30 bg-green-500/10 px-3 py-2.5 text-sm text-green-300">
