// Migrado de components/Dashboard/DashboardCorretor.jsx
import React, { useEffect, useState } from "react";
import generateStableKey from 'utils/generateStableKey';
import {
  Users, UserCheck, UserPlus, ClipboardList, Loader2, AlertTriangle, TrendingUp, Clock, Eye, Edit, Trash2, ArrowUp, ArrowDown, MoreHorizontal, Activity, Calendar, Zap, Target, Database, Signal, Globe, Server, Monitor, Cpu, BarChart3, PieChart as PieChartIcon, LineChart as LineChartIcon, Filter, Search, Bell, Settings, Award, Star, CheckCircle, XCircle, Mail, Phone, RefreshCw
} from "lucide-react";
